...
const storage = multer.diskStorage({
  ...
  filename: (req, file, cb) => {
      const uniqueName = Date.now() + '-' + file.originalname; // Unique name: timestamp + original name
      cb(null, uniqueName); // Save file with this unique name
  }
});
...
const uploadRoutes = require('./routes/upload'); // Adjust the path based on your folder structure
